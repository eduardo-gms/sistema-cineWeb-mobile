...
export default function App() {
    ...
    return (<SafeAreaProvider>
      ...
      <NavigationContainer>
        ...
        <Stack.Screen name="MyTickets" component={MyTicketsScreen} options={{ title: 'CineWeb Ingressos (Modo de Demonstração)' }}/>) : (
        // Grupo de Telas Privadas do Aplicativo do Cliente
        <Stack.Screen name="MyTickets" component={MyTicketsScreen} options={{ title: 'Meus Ingressos' }}/>)}
        </Stack.Navigator>
      </NavigationContainer>
    </SafeAreaProvider>);
}
